...
\begin{zremark}
  \textbf{定理.} 设线性变换 $\mathscr{P}:V\to V$，则以下条件等价：

  \begin{enumerate}
    \item $\mathscr{P}$ 是 $V$ 到某个子空间 $M$ 的投影；
    \item $\mathscr{P}^2 = \mathscr{P}$ 且 $\operatorname{Im}(\mathscr{P}) = M$。
  \end{enumerate}\end{zremark}
...
\begin{itemize}
  ...
  \item $2 \to 1$
        ...
        \begin{align*}
          dim M + dim N
           & = dim\, Im\mathscr{P} + dim\, Ker\mathscr{P}            \\
           & = dim\, Im\mathscr{P} + (dim\, V - dim\, V/Ker\mathscr{P}) \\
           & = dim\, Im\mathscr{P} + (dim\, V - dim\, Im\mathscr{P}) \\
           & = dim\, V
        \end{align*}
        接下来证明$M \oplus N$。反证法$M \cap N \neq \{0\}$， 即
        存在$\alpha \in M \cap N = Ker \mathscr{P} \cap Im \mathscr{P}$。

        由$\alpha \in Ker \mathscr{P}$，则
        \begin{align*}
          \mathscr{P}(\alpha) & = 0
        \end{align*}

        由$\alpha \in Im \mathscr{P}$，则且存在$\alpha_1 \in V$使得
        \begin{align*}
          \mathscr{P}(\alpha_1) = \alpha
        \end{align*}
        已知$\mathscr{P}^2 = \mathscr{P}$，于是
        \begin{align*}
          \mathscr{P}^2(\alpha_1)
           & = \mathscr{P}(\mathscr{P}(\alpha_1)) \\
           & = \mathscr{P}(\alpha)              \\
           & = 0
        \end{align*}
        又$ \mathscr{P}^2(\alpha_1) = \mathscr{P}(\alpha_1) \neq 0$出现矛盾，
        假设不成立，即
        \begin{align*}
          Im\mathscr{P} \oplus Ker\mathscr{P} = M \oplus N
        \end{align*}
        且有
        \begin{align*}
          V = M \oplus N
        ...
        \end{align*}
        因为$\mathscr{P}(\alpha) \in Im \mathscr{P} = M$，
        \begin{align*}
          \mathscr{P}(\alpha - \mathscr{P}(\alpha))
           ...
           & = 0
        \end{align*}
        所以，$\alpha - \mathscr{P}(\alpha) \in Ker\mathscr{P} = N$。

        综上可得
        \begin{align*}
          \alpha
           & = \mathscr{P}(\alpha) + (\alpha - \mathscr{P}(\alpha))       \\
           & = \alpha_1 + \alpha_2 \ \ \ (\alpha_1 \in M, \alpha_2 \in N)
        \end{align*}
        且
        \begin{align*}
          \mathscr{P}( \alpha ) = \alpha_1
